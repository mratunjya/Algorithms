...
- ⚓Fork this repository by click the Fork button in the top right of this page or simply [click here](https://github.com/mratunjya/Algorithms).
...
- ⚓Put your files in correct formaat like .py in Python, .js in Javascript etc.
